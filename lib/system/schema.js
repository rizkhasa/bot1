module.exports = (m, env) => {
   ...
   if (setting) {
      ...
      if (!('owners' in setting)) setting.owners = ['6289653898291']
      ...
      if (!('cover' in setting)) setting.cover = 'https://telegra.ph/file/3ea91587e84f33eba22fb.png'
      if (!('link' in setting)) setting.link = 'https://ksrcloud.dev/'
   } else {
      global.db.setting = {
         autodownload: true,
         debug: false,
         ...
         online: true,
         onlyprefix: '+',
         owners: ['6289653898291'],
         lastReset: new Date * 1,
         msg: 'Hi +tag 🪸\nI am an automated system (WhatsApp Bot) that can help to do something, search and get data / information only through WhatsApp.\n\n◦ *Database* : +db\n◦ *Library* : Baileys v+version\n◦ *Rest API* : https://api.neoxr.my.id\n◦ *Source* : https://github.com/neoxr/wbot\n\nIf you find an error or want to upgrade premium plan contact the owner.',
         style: 4,
         cover: 'https://telegra.ph/file/3ea91587e84f33eba22fb.png',
         link: 'https://ksrcloud.dev/'
      }
   }
}
